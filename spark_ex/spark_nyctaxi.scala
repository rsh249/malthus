...
val df3 = df2.selectExpr("split_path[6]", "fare_amount")
...
filter1.coalesce(1).write.csv("spark_taxidata_filter") // writes output to single file in folder spark_nyse_filter
